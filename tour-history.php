        ...
        <div class="privacy">
            <div class="container">
                <h3 class="wow fadeInDown animated animated" data-wow-delay=".5s"
                    style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Mi historial de
                    viaje</h3>
                            ...
                            <?php if($result->status==2)
{
	?><td>Cancelado</td>
                            ...
                            <td><a href="tour-history.php?bkid=<?php echo htmlentities($result->bookid);?>"
                                    onclick="return confirm('¿Realmente quieres cancelar la reserva?')">Cancelar</a>
                            </td>
                            <?php }?>
                        </tr>
                        <?php $cnt=$cnt+1; }} ?>
