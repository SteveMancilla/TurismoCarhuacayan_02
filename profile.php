        ...
        <div class="banner-1 ">
            <div class="container">
                <h1 class="wow zoomIn animated animated" data-wow-delay=".5s"
                    style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Sistema de Gestión
                    Turística</h1>
            </div>
        </div>
        <!--- /banner-1 ---->
        ...
        <div class="privacy">
            <div class="container">
                <h3 class="wow fadeInDown animated animated" data-wow-delay=".5s"
                    style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Mi Perfil!!</h3>
...
{	?>
                    ...
                    <p style="width: 350px;">
                        ...
                        <b>Nombre</b> <input type="text" name="name"
