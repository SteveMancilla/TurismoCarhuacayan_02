...
<head>
    <title>CARHUACAYAN | Administrador gestionar reservas</title>
...
<body>
    <div class="page-container">
        ...
        <div class="left-content">
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Inicio</a><i class="fa fa-angle-right"></i>Gestionar
                    reservas</li>
            </ol>
	...
	?><td>Cancelado</td>
                                    ...
                                    <td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>"
                                        ...
                                        / <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>"
                                            onclick="return confirm('La reserva ha sido confirmada')">Confirmar</a></td>
                                    <?php }?>
