...
<head>
    <title>Carhuacayan | Creación del paquete de administración</title>
...
<body>
    <div class="page-container">
        ...
        <div class="left-content">
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Inicio</a><i class="fa fa-angle-right"></i>Crear paquete
                </li>
            </ol>
            <!--grid-->
            <div class="grid-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="packagename" id="packagename"
                                            placeholder="Crear paquete" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="packagelocation"
                                            id="packagelocation" placeholder=" Ubicación del paquete" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control1" name="packageprice" id="packageprice"
                                            placeholder=" El precio del paquete es en USD" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" rows="5" cols="50" name="packagedetails"
                                            id="packagedetails" placeholder="Detalles del paquete" required></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
