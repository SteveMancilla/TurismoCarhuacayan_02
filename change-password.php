        ...
        <div class="privacy">
            <div class="container">
                <h3 class="wow fadeInDown animated animated" data-wow-delay=".5s"
                    style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Cambiar la
                    contraseña</h3>
                <form name="chngpwd" method="post" onSubmit="return valid();">
                    ...
                    <p style="width: 350px;">
                        ...
                        <b>Contraseña actual</b> <input type="password" name="password" class="form-control"
                            id="exampleInputPassword1" placeholder="Contraseña actual" required="">
                    </p>
