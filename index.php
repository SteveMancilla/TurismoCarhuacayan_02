    ...
    <div class="banner">
        <div class="container">
            <h1 class="wow zoomIn animated animated" data-wow-delay=".5s"
                style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Turismo Carhuacayan</h1>
        </div>
    </div>
        ...
        <div class="rupes">
            ...
            <div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s"
                ...
                <div class="rup-rgt">
                    ...
                    <h4><a href="offers.html">EN HOTELES EN LA ZONA</a></h4>
            ...
            <div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s"
                ...
                <div class="rup-rgt">
                    ...
                    <h4><a href="offers.html">OFERTA DE APLICACIÓN DE CARHUACAYAN</a></h4>
