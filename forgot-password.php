        ...
        <div class="privacy">
            <div class="container">
                <h3 class="wow fadeInDown animated animated" data-wow-delay=".5s"
                    style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Recuperar contraseña
                </h3>
                <form name="chngpwd" method="post" onSubmit="return valid();">
                    ...
                    <p style="width: 350px;">
                        ...
                        <b>No. Celular</b> <input type="text" name="mobile" class="form-control" id="mobile"
                            placeholder="Registre número celular" required="">
                    </p>
